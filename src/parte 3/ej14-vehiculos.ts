...
export class Auto extends Vehiculo {
    acelerar(): void {
    console.log(`${this.marca} ${this.modelo} auto está acelerando`);
    }
}

export class Moto extends Vehiculo {
    acelerar(): void {
    console.log(`${this.marca} ${this.modelo} moto está acelerando`);
    }
}

export class Camion extends Vehiculo {
    acelerar(): void {
    console.log(`${this.marca} ${this.modelo} camión está acelerando`);
    }
}
